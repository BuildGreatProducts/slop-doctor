...
export const intake = {
  ...
  submit: "Get my slop report",
  signInTitle: "Sign in to get your slop report",
  continueWithGoogle: "Continue with Google",
  signInNote: "Signing in keeps the clinic open. You get 10 examinations a day.",
  close: "Close",
  exampleLabel: "Example report",
  exampleAlt: "An example slop chart for synergize.example.com: Slop Index 98, diagnosis Code Purple",
  exampleCaption: "Every examination ends with a chart like this one, ready to share.",
