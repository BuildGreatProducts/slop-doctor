...
- **Mood faces:** the three determination cards carry a 40px pencil-line face on the right (circle, two dot eyes, and a smile, flat line or frown), drawn like the pencil-line doctor: `pencil`, 1.5px, never coloured. The card is a two-column grid: text, then the face centred vertically.
